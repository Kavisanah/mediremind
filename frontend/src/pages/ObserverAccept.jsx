...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-20 md:pb-8">
      ...
      {/* Hero header */}
      <div className="bg-mesh-primary relative overflow-hidden border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="animate-slide-up">
            ...
            <p className="text-slate-300 mt-1 text-sm">Here's your health overview for today.</p>
          </div>
        </div>
      </div>
